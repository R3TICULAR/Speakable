...
const TIERS: Tier[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { textKey: 'featureTeamShapeRoadmap' },
      { textKey: 'featureTeamVolume' },
      { textKey: 'featureTeamPitch' },
      { textKey: 'featureTeamAsk', bold: true },
    ],
    ctaKey: 'ctaTeam',
    recommended: false,
  },
...
export default function PricingPage() {
  ...
  const handleCta = async (tierId: string) => {
    ...
    if (tierId === 'team-enterprise') {
      window.location.href = 'mailto:support@getspeakable.dev';
      return;
    }
